			...
			<div class="row">
				<div class="col s12 m6 small">
					<div class="card blue-grey darken-1">
						...
						<div class="card-action">
							<center>
								<a href="<?php echo base_url('facultyController/studentInFaculty/1')?>" style="width: 100%; display: block;">View Students</a>
							</center>
						</div>
					</div>
				</div>
				<div class="col s12 m6 small">
					<div class="card blue-grey darken-1">
						...
						<div class="card-action">
							<center>
								<a href="<?php echo base_url('facultyController/studentInFaculty/2')?>" style="width: 100%; display: block;">View Students</a>
							</center>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col s12 m6 small">
					<div class="card blue-grey darken-1">
						...
						<div class="card-action">
							<center>
								<a href="<?php echo base_url('facultyController/studentInFaculty/3')?>" style="width: 100%; display: block;">View Students</a>
							</center>
						</div>
					</div>
				</div>
				<div class="col s12 m6 small">
					<div class="card blue-grey darken-1">
						...
						<div class="card-action">
							<center>
								<a href="<?php echo base_url('facultyController/studentInFaculty/4')?>" style="width: 100%; display: block;">View Students</a>
							</center>
						</div>
					</div>
				</div>
