...
<style type=text/css>.pad{padding:25px}@media screen and (min-width:991px){.container{margin-right:10%}}</style>
</head>
<body bgcolor=#f1f1f1>
...
<script type=text/javascript>$(".button-collapse").sideNav();$(document).ready(function(){$("select").material_select()});$(".datepicker").pickadate({selectMonths:true,selectYears:70});</script>
</body>
</html>