...
<html>
<head>
	<title>Student In Faculty</title>
	<style type="text/css">
	</style>
  ...
  <div class="container">
    <div class="card-panel z-depth-2 center" style="margin-top: 60px;">
      <table class = "highlight">
        ...
        <?php
        foreach($studentInFaculty as $key){ ?>

        <tbody>
          <tr>
            <td>
              <a href = '<?php echo base_url("facultyController/loadStudentReport/".$key->usn);?>'><?php echo $key->student_name;?></a>
            </td>
            <td>
              <?php echo $key->usn;?>
            </td>
